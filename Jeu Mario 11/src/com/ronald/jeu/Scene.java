...
import com.ronald.objets.Bloc;
import com.ronald.objets.Objet;
import com.ronald.objets.TuyauRouge;
import com.ronald.personnages.Mario;
...
public class Scene extends JPanel {
	...
	private ArrayList<Objet> tabObjets; // tableau qui enregistre tous les objets du jeux
	...
	public void paintComponent(Graphics g) { // Dessin de toutes les images visibles � l'�cran (appel toutes les 3 ms environ)
		...
		//Detection contact de mario avec les objets(bloc1 et tuyauRouge1)
